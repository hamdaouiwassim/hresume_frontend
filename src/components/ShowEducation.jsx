...
export default function ShowEducation({ exp, index, hide, resumeId, onSave, onDelete }) {
    ...
    return (
        <>
            {edit ? (
                <NewEducation exp={exp} index={index} edit={true} hide={handleHide} resumeId={resumeId} onSave={onSave} />
            ) : (
                <>
