...
export default function ShowExperience({ exp, index, hide, resumeId, onSave, onDelete }) {
    ...
    return (
        <>
            {edit ? (
                <NewExperience exp={exp} index={index} edit={true} hide={handleHide} resumeId={resumeId} onSave={onSave} />
            ) : (
                <>
